...
%>	
	<div id="wrap">
		...
		<section class="contents">
			<div class="d-flex banner mt-2 p-3">
				<div>
				...
				<table class="table">
					...
					<% for(Map<String, Object>music:musicList){ %>
						<tr class="text-center">
							<td><a href="/jsp/test/test10.jsp?id=<%= music.get("id") %>"><%= music.get("id") %></a></td>
							<td><a href="/jsp/test/test10.jsp?id=<%= music.get("id") %>"><%= music.get("title") %></a></td>
